...
STAGES = [
    ...
    ("shotorder", [{"argv": ["tools/shot_order_stability.py"], "env": {"CAMPAIGN_V_EPOCH": "E1"}}],
     ["data/shot_order_stability.json"],
     "whether the row order carries time structure, and within-unit stability"),
